...
if(isset($_POST['Submit_Mail_List'])){
	...
	if($email==""){
		...
		$query = "INSERT INTO mailing_list(name,phone,email,comments) VALUES
...
<script type="text/javascript">
	function validateForm(){
		...
		if(phone==""){phoneMsg.innerHTML = "Your phone number cannot be blank."; 
	return false;}
		if(email==""){emailMsg.innerHTML = "Your email address cannot be blank.";
	return false;}
	}
</script>
